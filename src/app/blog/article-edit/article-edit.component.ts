...
export class ArticleEditComponent implements OnInit {
  ...
  updatePoost(formData: NgForm,id:number,title:string,author:string,image:string,publishdate:string,excert:string) {
    console.log(this.title)
    this.config.updatePoost(formData,this.id,this.title,this.author,this.image,this.publishdate,this.excert).subscribe(
      () => this.getBack()
    );
  }
