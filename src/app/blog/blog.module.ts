...
@NgModule({
  ...
  declarations: [BlogPageComponent, ArticleComponent, ArticleCreateComponent, ArticleEditComponent, PostBlockComponent, PaginationComponent, ArticleDeleteComponent, ArticleBuyComponent],
